<?php 
$pageTitle = "Fairdeal - Premium Casino Game";
include 'header.php'; 
?>
...
<div class="container my-5">
    <div class="game-header text-center mb-5 fade-in-up">
        <h1 class="game-title">🎰 Fairdeal 🎰</h1>
        <p class="game-subtitle">Premium Casino Game Platform</p>
        <p class="game-description">Experience the thrill of live casino action with real-time odds and massive payouts up to 5000x!</p>
        <div class="game-stats-row">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">5,000x</div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            ...
            <div class="game-banner-container mb-5">
                <img src="assets/fairdeal-game.webp" alt="Fairdeal Game" class="game-banner-image">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="bet-section mb-4">
                            ...
                            <div class="bet-controls-row">
                                ...
                                <input type="number" id="betInput" class="bet-input-field" value="10" min="5" max="2500" step="10">
                                <button class="btn-bet-adjust" onclick="adjustBet(10)">
                        ...
                        <div class="action-buttons-row">
                            <button class="btn-play-main" id="playBtn" onclick="playFairdeal()">
            ...
            <div class="game-info-container mt-5">
                <div class="card info-card">
                    <div class="card-body p-5">
                        ...
                        <h2 class="info-title"><i class="fas fa-info-circle me-3"></i>How to Play Fairdeal</h2>
                        
                        <div class="info-section">
                            <h4>🎮 Game Overview</h4>
                            <p>Fairdeal is a premium casino game game that combines the excitement of live casino action with the potential for massive wins. With a maximum payout of 5,000x your bet, every spin could change your fortune! Our advanced algorithm ensures fair play while delivering an authentic casino experience.</p>
                        </div>
                        ...
                        <div class="info-section">
                            ...
                            <div class="payout-grid">
                                ...
                                <div class="payout-item payout-jackpot">
                                    <div class="payout-multiplier">5,000x</div>
                        ...
                        <div class="info-section">
                            ...
                            <p>Fairdeal features immersive audio and visual effects to enhance your gaming experience:</p>
