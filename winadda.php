    ...
    <div class="game-header text-center mb-5 fade-in-up">
        ...
        <div class="game-stats-row">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">10,000x</div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            ...
            <div class="game-banner-container mb-5">
                <img src="assets/winadda-game.webp" alt="Winadda Game" class="game-banner-image">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="bet-section mb-4">
                            ...
                            <div class="bet-controls-row">
                                ...
                                <input type="number" id="betInput" class="bet-input-field" value="10" min="10" max="5000" step="10">
                                <button class="btn-bet-adjust" onclick="adjustBet(10)">
                        ...
                        <div class="action-buttons-row">
                            <button class="btn-play-main" id="playBtn" onclick="playWinadda()">
            ...
            <div class="game-info-container mt-5">
                <div class="card info-card">
                    <div class="card-body p-5">
                        ...
                        <h2 class="info-title"><i class="fas fa-info-circle me-3"></i>How to Play Winadda</h2>
                        ...
                        <div class="info-section">
                            ...
                            <div class="payout-grid">
                                ...
                                <div class="payout-item payout-jackpot">
                                    <div class="payout-multiplier">10,000x</div>
                        ...
                        <div class="info-section">
                            ...
                            <p>Winadda features immersive audio and visual effects to enhance your gaming experience:</p>
