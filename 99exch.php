<?php 
$pageTitle = "99exch - Premium Casino Game";
include 'header.php'; 
?>
...
<div class="container my-5">
    <div class="game-header text-center mb-5 fade-in-up">
        <h1 class="game-title">🎰 99exch 🎰</h1>
        <p class="game-subtitle">Premium Casino Game Platform</p>
        <p class="game-description">Experience the thrill of live casino action with real-time odds and massive payouts up to 20000x!</p>
    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            ...
            <div class="game-banner-container mb-5">
                <img src="assets/99exch-game.webp" alt="99exch Game" class="game-banner-image">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="bet-section mb-4">
                            ...
                            <div class="bet-controls-row">
                                ...
                                <input type="number" id="betInput" class="bet-input-field" value="50" min="50" max="10000" step="10">
                                <button class="btn-bet-adjust" onclick="adjustBet(50)">
                                    <i class="fas fa-plus"></i>
                                </button>
                            </div>
                            <div class="quick-bets mt-3">
                                <button class="btn-quick" onclick="setQuickBet(50)">10</button>
                        ...
                        <div class="action-buttons-row">
                            <button class="btn-play-main" id="playBtn" onclick="play99exch()">
            ...
            <div class="game-info-container mt-5">
                <div class="card info-card">
                    <div class="card-body p-5">
                        ...
                        <h2 class="info-title"><i class="fas fa-info-circle me-3"></i>How to Play 99exch</h2>
                        
                        <div class="info-section">
                            <h4>🎮 Game Overview</h4>
                            <p>99exch is a premium casino game game that combines the excitement of live casino action with the potential for massive wins. With a maximum payout of 20,000x your bet, every spin could change your fortune! Our advanced algorithm ensures fair play while delivering an authentic casino experience.</p>
                        </div>
                        ...
                        <div class="info-section">
                            ...
                            <div class="payout-grid">
                                ...
                                <div class="payout-item payout-jackpot">
                                    <div class="payout-multiplier">20,000x</div>
                        ...
                        <div class="info-section">
                            ...
                            <p>99exch features immersive audio and visual effects to enhance your gaming experience:</p>
...
function adjustBet(amount) {
    ...
    newValue = Math.max(50, Math.min(newValue, 5000, playerBalance));
