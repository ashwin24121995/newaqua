<?php 
$pageTitle = "Laser 247 - Premium Casino Game";
include 'header.php'; 
?>
...
<div class="container my-5">
    <div class="game-header text-center mb-5 fade-in-up">
        <h1 class="game-title">🎰 Laser 247 🎰</h1>
        <p class="game-subtitle">Premium Casino Game Platform</p>
        <p class="game-description">Experience the thrill of live casino action with real-time odds and massive payouts up to 2470x!</p>
        <div class="game-stats-row">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">2,470x</div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="bet-section mb-4">
                            ...
                            <div class="bet-controls-row">
                                ...
                                <input type="number" id="betInput" class="bet-input-field" value="1" min="1" max="1000" step="10">
                                <button class="btn-bet-adjust" onclick="adjustBet(1)">
                                    <i class="fas fa-plus"></i>
                                </button>
                            </div>
                            <div class="quick-bets mt-3">
                                <button class="btn-quick" onclick="setQuickBet(1)">10</button>
                        ...
                        <div class="action-buttons-row">
                            <button class="btn-play-main" id="playBtn" onclick="playLaser 247()">
            ...
            <div class="game-info-container mt-5">
                <div class="card info-card">
                    <div class="card-body p-5">
                        ...
                        <h2 class="info-title"><i class="fas fa-info-circle me-3"></i>How to Play Laser 247</h2>
                        
                        <div class="info-section">
                            <h4>🎮 Game Overview</h4>
                            <p>Laser 247 is a premium casino game game that combines the excitement of live casino action with the potential for massive wins. With a maximum payout of 2,470x your bet, every spin could change your fortune! Our advanced algorithm ensures fair play while delivering an authentic casino experience.</p>
                        </div>
                        ...
                        <div class="info-section">
                            ...
                            <div class="payout-grid">
                                ...
                                <div class="payout-item payout-jackpot">
                                    <div class="payout-multiplier">2,470x</div>
                        ...
                        <div class="info-section">
                            ...
                            <p>Laser 247 features immersive audio and visual effects to enhance your gaming experience:</p>
...
function adjustBet(amount) {
    ...
    newValue = Math.max(1, Math.min(newValue, 5000, playerBalance));
