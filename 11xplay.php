<?php 
$pageTitle = "11xplay - Premium Casino Game";
include 'header.php'; 
?>
...
<div class="container my-5">
    <div class="game-header text-center mb-5 fade-in-up">
        ...
        <p class="game-description">Experience the thrill of live casino action with real-time odds and massive payouts up to 11x!</p>
                ...
                <div class="card info-card">
                    <div class="card-body p-5">
                        ...
                        <div class="info-section">
                            <h4>🎮 Game Overview</h4>
                            <p>11xplay is a premium casino game game that combines the excitement of live casino action with the potential for massive wins. With a maximum payout of 11x your bet, every spin could change your fortune! Our advanced algorithm ensures fair play while delivering an authentic casino experience.</p>
                        </div>
